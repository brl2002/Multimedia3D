...
public:
	...
	void Translate(D3DXVECTOR3 trans) {Translate(p_light.Position.x,p_light.Position.y,p_light.Position.z); }
	void Translate(float x,float y,float z) { p_light.Position.x += x; p_light.Position.y += y; p_light.Position.z += z; }
