...
namespace Advanced2D {
	...
	protected:
		...
		bool usePortion;
		RECT portionRect;
		std::vector<RECT> animationRects;
	...
	public:
		...
		RECT getPortionRect() { return portionRect; }
		void setPortionRect(RECT rect);

		std::vector<RECT> getAnimationRects() { return animationRects; }
		void setAnimationRects(std::vector<RECT> rects);
